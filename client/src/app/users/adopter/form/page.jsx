      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="max-w-2xl mx-auto p-4">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                conocerte mejor y contactarte durante el proceso de adopción.
                Esta información es confidencial y solo se utilizará para
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Ayúdanos a conocer mejor el espacio donde vivirá la mascota.
                Esto nos permite asegurarnos de que el entorno sea adecuado y
                seguro para su bienestar.
              </p>
              <div className="mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                convivirá la mascota. Esta información nos ayuda a asegurarnos
                de que la adopción sea una buena experiencia tanto para ti como
                para tu familia.
              </p>
              <div className="mb-4">
                <input
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Comparte tu experiencia previa con mascotas y el nivel de
              compromiso que puedes ofrecer. Esto nos ayudará a encontrar la
              mejor mascota para ti.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              para completar el proceso. Luego, súbelo en el formulario y envía
              tu aplicación.
            </p>
